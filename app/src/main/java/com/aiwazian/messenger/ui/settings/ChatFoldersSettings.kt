        ...
        Column(modifier = Modifier.padding(innerPadding)) {
            ...
            Column(
                ...
                val composition by rememberLottieComposition(
                    spec = LottieCompositionSpec.Asset("folders.json")
                )
            ...
            SectionHeader(title = stringResource(R.string.chatFolders))
...
private fun TopBar() {
    ...
    PageTopBar(
        title = { Text(stringResource(R.string.chatFolders)) },
        navigationIcon = {
            IconButton(onClick = {
